                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Department">{{ val.department }}</td>
                            <td class="whitespace-nowrap" label="Position">{{ val.position }}</td>
                            <td class="whitespace-nowrap" label="HireDate">{{ val.hireDate }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Employee 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            <Number label="EmployeeId" v-model="selectedRow.employeeId" :editMode="true"/>
                            <String label="Name" v-model="selectedRow.name" :editMode="true"/>
                            <String label="Department" v-model="selectedRow.department" :editMode="true"/>
                            <String label="Position" v-model="selectedRow.position" :editMode="true"/>
                            <Date label="HireDate" v-model="selectedRow.hireDate" :editMode="true"/>
