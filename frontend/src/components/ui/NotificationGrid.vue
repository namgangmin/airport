                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="WriteDate">{{ val.writeDate }}</td>
        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <Number label="NotificationsId" v-model="selectedRow.notificationsId" :editMode="true"/>
                            ...
                            <Date label="WriteDate" v-model="selectedRow.writeDate" :editMode="true"/>
